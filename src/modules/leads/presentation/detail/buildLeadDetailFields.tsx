...
export function buildLeadDetailFields({
  ...
  return [
    { section: locale === "vi" ? "Thông tin chung" : "General Information", id: "code", label: locale === "vi" ? "Mã khách hàng tiềm năng" : "Lead ID", value: l.id, isEmpty: !l.id },
    ...
    { section: locale === "vi" ? "Thông tin cá nhân" : "Personal Information", id: "salutation", label: locale === "vi" ? "Danh xưng xưng hô" : "Salutation", value: l.salutation || "", isEmpty: !l.salutation },
    ...
    { section: locale === "vi" ? "Thông tin cá nhân" : "Personal Information", id: "preferredChannel", label: locale === "vi" ? "Kênh liên lạc quen dùng" : "Preferred Channel", value: l.preferredChannel || "", isEmpty: !l.preferredChannel },

    { section: locale === "vi" ? "Thông tin tổ chức" : "Organization Information", id: "companyName", label: locale === "vi" ? "Tên công ty doanh nghiệp" : "Company / Business Name", value: l.companyName || "", isEmpty: !l.companyName },
    ...
    { section: locale === "vi" ? "Thông tin tổ chức" : "Organization Information", id: "website", label: locale === "vi" ? "Website" : "Website", value: l.website || "", isEmpty: !l.website },
    ...
    { section: locale === "vi" ? "Thông tin địa chỉ" : "Address Information", id: "city", label: locale === "vi" ? "Tỉnh / Thành phố" : "City / State", value: l.province || "", isEmpty: !l.province },
    ...
    { section: locale === "vi" ? "Thông tin hệ thống" : "System Information", id: "archivedAt", label: locale === "vi" ? "Thời điểm lưu trữ" : "Archived At", value: l.archivedAt ? formatDateTime(l.archivedAt, locale) : "", isEmpty: !l.archivedAt },
    { section: locale === "vi" ? "Thông tin hệ thống" : "System Information", id: "archiveReason", label: locale === "vi" ? "Lý do lưu trữ" : "Archive Reason", value: l.archiveReason || "", isEmpty: !l.archiveReason },
