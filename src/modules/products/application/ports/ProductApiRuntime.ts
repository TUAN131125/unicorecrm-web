...
export interface ProductQueryPort { list(query?: ProductListQuery, signal?: AbortSignal): Promise<AuthoritativePage<Product>>; get(productId: string, signal?: AbortSignal): Promise<Product>; getAvailability(productId: string, signal?: AbortSignal): Promise<ProductAvailability>; getPriceProjection(productId: string, quantity: string, signal?: AbortSignal): Promise<ProductPriceProjection>; }
