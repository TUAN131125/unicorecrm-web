...
export class ProductHttpApiAdapter implements ProductQueryPort, ProductCommandPort {
  ...
  getAvailability(productId: string, signal?: AbortSignal) { return this.api.getProductAvailability<ProductAvailabilityReadModel>(productId, {}, signal); }
  getPriceProjection(productId: string, quantity: string, signal?: AbortSignal) { return this.api.getProductPriceProjection<ProductPriceProjectionReadModel>(productId, { quantity }, signal); }
